...
class GCSFileStatTest(unittest.TestCase):
    ...
    def testValidation(self):
        ...
        common.GCSFileStat(
            "/bucket/file", st_size=None, etag=None, st_ctime=None, is_dir=True
        )
...
class HelpersTest(unittest.TestCase):
    ...
    def testProcessPathPrefix(self):
        ...
        self.assertEqual(("/bucket", None), common._process_path_prefix("/bucket/"))
        self.assertEqual(
            ("/bucket", "prefix/"), common._process_path_prefix("/bucket/prefix/")
        )
    ...
    def testDatetimeConversion(self):
        ...
        self.assertEqual(dt_str, common.posix_to_dt_str(common.dt_str_to_posix(dt_str)))
